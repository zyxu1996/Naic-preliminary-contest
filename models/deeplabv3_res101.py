...
from .resnet import resnet101_v1s
...
class SegBaseModel(nn.Module):
    ...
    def __init__(self, nclass, aux, backbone='resnet101', jpu=False, pretrained_base=True, **kwargs):
...
class DeepLabV3(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet101', aux=False, pretrained_base=False, **kwargs):
